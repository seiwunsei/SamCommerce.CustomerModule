...
using SamCommerce.CustomerModule.Core.Events;
using SamCommerce.CustomerModule.Core.Model;
using SamCommerce.CustomerModule.Core.Services;
using SamCommerce.CustomerModule.Data.Caching;
...
using SamCommerce.Platform.Data.Infrastructure;
using SamCommerce.Platform.Security.Caching;
using System;
...
namespace SamCommerce.CustomerModule.Data.Services
{
    /// <summary>
